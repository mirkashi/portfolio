  ...
  const contactMethods = [
    {
      icon: FaEnvelope,
      label: "Email",
      value: "mirkashi111@gmail.com",
      href: "mailto:mirkashi111@gmail.com",
    },
    {
      icon: FaPhone,
      label: "Phone",
      value: "(+92) 318 5831 156",
      href: "tel:+923185831156",
    },
    {
      icon: FaMapMarkerAlt,
      label: "Location",
      value: "Islamabad city, Pakistan",
      href: "https://maps.google.com/?q=Islamabad+city+Pakistan",
    }
  ];

  const socialLinks = [
    { icon: FaGithub, href: "https://github.com/mirkashi", label: "GitHub" },
    { icon: FaLinkedin, href: "https://www.linkedin.com/in/mir-kashif-28987428b/", label: "LinkedIn" }
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-neutral-400 text-lg max-w-xl mx-auto">
              Looking for a  full-stack Developer? Let's connect and discuss how I can contribute to your team.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 rounded-2xl p-6 border border-amber-500/20">
                ...
                <p className="text-sm text-neutral-400 leading-relaxed">
                  Currently seeking internship opportunities as a Mern-stack Developer. Available to start immediately.
                </p>
              </div>
            </motion.div>
          </div>
