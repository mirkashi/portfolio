  ...
  const highlights = [
    {
      ...
      description: "Specialized in JavaScript and React.js"
    },
    {
      icon: <FaServer />,
      title: "Backend Focus",
    ...
    },
    {
      ...
      title: "BBIT Student",
      description: "Virtual University of Islamabad, Pakistan"
    },
    {
      icon: <FaMapMarkerAlt />,
      title: "Based in",
      description: "Islamabad city, Pakistan"
    }
  ];
          ...
          >
            <div className="relative">
              ...
              <div className="w-56 h-56 md:w-64 md:h-64 rounded-2xl overflow-hidden border-2 border-neutral-800 bg-neutral-900">
                <img
                  src="/ChatGPT Image Apr 11, 2026, 09_44_02 PM.png"
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-neutral-100 mb-2">
                Hi, I'm <span className="text-amber-400">Kashif Meer</span>
              </h3>
            ...
            <div className="space-y-4 text-neutral-400 leading-relaxed">
              <p>
                ...
                modern technologies. My expertise lies in <span className="text-amber-400">JavaScript</span> for 
            ...
            <div className="flex flex-wrap gap-6 pt-2">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-amber-400">1.5+</div>
